...
class TestModelRegistry:
    ...
    def test_get_fallback_chain(self) -> None:
        ...
        fallback1_model = ModelInfo(
            name="fallback1", provider=ProviderType.CLAUDE, semantic_type=ModelType.FAST
        )
        fallback2_model = ModelInfo(
            name="fallback2", provider=ProviderType.GEMINI, semantic_type=ModelType.FAST
        )
    ...
    def test_get_all_models(self) -> None:
        ...
        model1 = ModelInfo(
            name="model1", provider=ProviderType.OPENAI, semantic_type=ModelType.FAST
        )
        model2 = ModelInfo(
            name="model2", provider=ProviderType.CLAUDE, semantic_type=ModelType.SMART
        )
