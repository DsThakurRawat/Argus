...
@pytest.fixture
def prompt_manager(temp_storage: str) -> None:
...
class TestPromptManager:
    ...
    def test_create_prompt(self, prompt_manager: str) -> None:
    ...
    def test_get_prompt(self, prompt_manager: str) -> None:
    ...
    def test_test_prompt(self, prompt_manager: str) -> None:
    ...
    def test_list_prompts(self, prompt_manager: str) -> None:
    ...
    def test_get_prompt_versions(self, prompt_manager: str) -> None:
    ...
    def test_prompt_not_found(self, prompt_manager: str) -> None:
    ...
    def test_version_not_found(self, prompt_manager: str) -> None:
...
class TestPromptEnvironment:
    ...
    def test_environment_deployment(self, prompt_manager: str) -> None:
...
class TestPromptCollaborationManager:
    ...
    def test_collaboration_workflow(self, prompt_manager: str) -> None:
    ...
    def test_review_rejection(self, prompt_manager: str) -> None:
    ...
    def test_review_not_found(self, prompt_manager: str) -> None:
...
class TestPersistence:
    ...
    def test_save_and_load_prompts(self, temp_storage: str) -> None:
    ...
    def test_version_persistence(self, temp_storage: str) -> None:
