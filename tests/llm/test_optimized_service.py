...
from argus.llm.optimized_service import OptimizedLLMService
...
class TestOptimizedLLMService:
    ...
    @pytest.mark.asyncio
    async def test_generate_structured_with_optimizations(
    ...
    async def test_warmup(self, optimized_service, mock_enhanced_service):
        """Test service warmup."""
        with patch.object(optimized_service, "_enhanced_service_loader") as mock_loader:
            mock_enhanced_service.model_registry.get_model = MagicMock(
