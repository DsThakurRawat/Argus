...
class TestCircuitBreaker:
    ...
    def test_initialization_with_params(self, circuit_breaker: str) -> None:
    ...
    def test_state_property_auto_transition(self, circuit_breaker: str) -> None:
    ...
    def test_should_attempt_reset(self, circuit_breaker: str) -> None:
    ...
    def test_open_circuit(self, circuit_breaker: str) -> None:
    ...
    def test_close_circuit(self, circuit_breaker: str) -> None:
    ...
    def test_half_open_circuit(self, circuit_breaker: str) -> None:
    ...
    def test_on_success_closed_state(self, circuit_breaker: str) -> None:
    ...
    def test_on_success_half_open_state(self, circuit_breaker: str) -> None:
    ...
    def test_on_failure_closed_state(self, circuit_breaker: str) -> None:
    ...
    def test_on_failure_half_open_state(self, circuit_breaker: str) -> None:
