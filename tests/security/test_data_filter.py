...
@pytest.fixture
def data_filter() -> None:
    """Create a DataFilter instance."""
    return DataFilter()


@pytest.fixture
def sample_filter_rule() -> None:
...
class TestDataFilter:
    ...
    def test_initialization(self, data_filter: str) -> None:
    ...
    def test_filter_text_api_key(self, data_filter: str) -> None:
    ...
    def test_filter_text_email(self, data_filter: str) -> None:
    ...
    def test_filter_text_phone(self, data_filter: str) -> None:
    ...
    def test_filter_text_ssn(self, data_filter: str) -> None:
    ...
    def test_filter_text_credit_card(self, data_filter: str) -> None:
    ...
    def test_filter_text_ip_address(self, data_filter: str) -> None:
    ...
    def test_filter_text_password(self, data_filter: str) -> None:
    ...
    def test_filter_text_jwt_token(self, data_filter: str) -> None:
    ...
    def test_filter_text_multiple_sensitive_data(self, data_filter: str) -> None:
    ...
    def test_filter_dict_nested(self, data_filter: str) -> None:
    ...
    def test_filter_list(self, data_filter: str) -> None:
    ...
    def test_get_sensitive_data_types(self, data_filter: str) -> None:
    ...
    def test_get_sensitive_data_types_none(self, data_filter: str) -> None:
        """Test getting types when no sensitive data found."""
        text = "Normal text"
        types = data_filter.get_sensitive_data_types(text)
        assert len(types) == 0

    def test_add_rule(self, data_filter: str) -> None:
    ...
    def test_add_rule_invalid_regex(self, data_filter: str) -> None:
    ...
    def test_remove_rule(self, data_filter: str) -> None:
    ...
    def test_disable_rule(self, data_filter: str) -> None:
    ...
    def test_get_rules_by_type(self, data_filter: str) -> None:
    ...
    def test_get_disabled_rules(self, data_filter: str) -> None:
    ...
    def test_validate_rules(self, data_filter: str) -> None:
    ...
    def test_validate_rules_with_invalid(self, data_filter: str) -> None:
...
class TestFilterRule:
    ...
    def test_filter_rule_creation(self, sample_filter_rule: str) -> None:
    ...
    def test_filter_rule_defaults(self) -> None:
...
class TestSensitiveDataType:
    ...
    def test_sensitive_data_types(self) -> None:
