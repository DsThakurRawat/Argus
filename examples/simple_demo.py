...
async def demo_resilience_config():
    ...
    try:
        ...
        logger.info(
            f"  Circuit breaker threshold: {dev_config.circuit_breaker['failure_threshold']}"
        )
        ...
        logger.info(
            f"  Circuit breaker threshold: {staging_config.circuit_breaker['failure_threshold']}"
        )
        ...
        logger.info(
            f"  Circuit breaker threshold: {prod_config.circuit_breaker['failure_threshold']}"
        )
