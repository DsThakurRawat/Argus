...
class Alert(BaseModel):
    ...
    provider_id: str = Field(..., description="The ID of the provider that triggered the alert.")
    ...
    value: float = Field(..., description="The value of the metric that triggered the alert.")
